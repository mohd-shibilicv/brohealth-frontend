        ...
        <Toolbar>
          ...
          <div className="w-full flex justify-between items-center mr-5">
            ...
            <Typography variant="h6" noWrap component="span" className="text-lg font-medium">
              Admin: {auth.account.first_name} {auth.account.last_name}
            </Typography>
        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            <ListItemButton
              ...
              selected={"/admin/appointments" === path}
            >
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            <ListItemButton
              ...
              component={Link}
              to="/admin/doctors"
              selected={"/admin/doctors" === path}
            >
              <Tooltip title="Doctors" placement="right-end">
                <ListItemIcon
                  sx={{
                    minWidth: 0,
                    mr: open ? 3 : "auto",
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            <ListItemButton
              ...
              selected={"/admin/notifications" === path}
            >
