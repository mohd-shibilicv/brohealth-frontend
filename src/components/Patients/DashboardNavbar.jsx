        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            <ListItemButton
              ...
              selected={"/dashboard/appointments" === path}
            >
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            <ListItemButton
              ...
              selected={"/dashboard/prescriptions" === path}
            >
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            <ListItemButton
              ...
              selected={"/dashboard/notifications" === path}
            >
          ...
          <List>
            <ListItem disablePadding sx={{ display: "block" }}>
              <ListItemButton
                ...
                selected={"/dashboard/profile" === path}
              >
            ...
            <ListItem disablePadding sx={{ display: "block" }}>
              <ListItemButton
                ...
                selected={"/dashboard/account" === path}
              >
